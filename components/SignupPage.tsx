              ...
              <h1>Register</h1>
                ...
                <TextField sx={{"& .MuiOutlinedInput-root": {
                        ...
                        borderColor: "white"
                          ...
                          }}  id="password" name='password' type='password' label="Password" variant="outlined" onChange={handleChange} style={{width: '400px'}} margin='normal'/>
                          {errors.password && touched.password ? (
                            <div style={{color: 'red'}}>{errors.password}</div>
                          ) : null}
              
              <button type="submit" className='button' style={{marginTop: '10px'}}>Sign up</button>
              <Link href='/'><button className='button' style={{marginTop: '10px'}}>Login</button></Link>
             </form>
           )}
        </Formik>
    </div>
